...
public class Constants {
        ...
        private static final String INSTANCE_ADDRESS = "bayelsa-cct.us1.cloud.realm.io";
        static public String AUTH_URL = "https://" + INSTANCE_ADDRESS + "/auth";
        static public String REALM_BASE_URL = "realms://" + INSTANCE_ADDRESS;
}
